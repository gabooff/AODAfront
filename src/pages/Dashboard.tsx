...
import { BarChart3, Users, MapPin, TrendingUp, AlertCircle, CheckCircle } from "lucide-react";
import Navigation from "@/components/Navigation";

const Dashboard = () => {
  // Datos simulados para KPIs
  const kpis = {
    derivacionesTotales: 1247,
    derivacionesHoy: 18,
    centrosActivos: 45,
  ...
  const derivacionesPorTipo = [
    { tipo: "Violencia Intrafamiliar", cantidad: 456, porcentaje: 36.6, color: "bg-red-500" },
    { tipo: "Delitos Sexuales", cantidad: 298, porcentaje: 23.9, color: "bg-orange-500" },
    { tipo: "Robo con Violencia", cantidad: 234, porcentaje: 18.8, color: "bg-yellow-500" },
  ...
  const centrosMasDerivados = [
    { centro: "Centro de Atención Integral San Miguel", derivaciones: 89, disponibilidad: "Alta" },
    { centro: "CAVS Santiago Centro", derivaciones: 76, disponibilidad: "Media" },
    { centro: "Centro de la Mujer Las Condes", derivaciones: 67, disponibilidad: "Alta" },
    { centro: "CAVI Maipú", derivaciones: 54, disponibilidad: "Baja" },
    { centro: "Centro Integral Puente Alto", derivaciones: 43, disponibilidad: "Alta" }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto py-8 px-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Dashboard de Indicadores</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Derivaciones Totales</CardTitle>
              <Users className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{kpis.derivacionesTotales.toLocaleString()}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{kpis.tiempoPromedioProceso}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Precisión AODA</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{kpis.satisfaccionUsuario}%</div>
                  ...
                  <div key={index} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <p className="text-sm font-medium truncate">{item.tipo}</p>
              ...
              <div className="space-y-4">
                {centrosMasDerivados.map((centro, index) => (
                  <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium truncate">{centro.centro}</p>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <Badge 
                      variant={
                        centro.disponibilidad === "Alta" ? "default" :
                        centro.disponibilidad === "Media" ? "secondary" : "destructive"
                      }
                      className="ml-2"
                    >
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-sm">Casos procesados automáticamente</span>
